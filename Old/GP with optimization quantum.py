# -*- coding: utf-8 -*-
"""
Created on Wed Jul 24 16:44:00 2024
...
def optimize_circuit(qc, n, m, angles, classic_images, normalization_factor, simulator, shots, calculate_classical_gp):
    def objective_function(theta):
        # Create a copy of the quantum circuit to modify
        qc_copy = qc.copy()

        # Set the angles for the RZ gates
        idx = 0
        ...
        # Calculate the MAD between classical and quantum images
    ...
    # Initial angles for the RZ gates
...
def calculate_gp(qc, n, m, classic_images, normalization_factor, simulator, shots):
    ...
    # Optimize the circuit angles to minimize MAD
    optimized_angles = optimize_circuit(qc, n, m, np.zeros((2 ** (2 * n) * 2 ** m)), classic_images, normalization_factor, simulator, shots, calculate_classical_gp)

    # Apply the optimized angles to the quantum circuit
    idx = 0
    for i in range(2 ** (2 * n)):
...
def main(image_names):
    ...
    qc = calculate_gp(qc, n, m, classic_images, normalization_factor, simulator, shots)
